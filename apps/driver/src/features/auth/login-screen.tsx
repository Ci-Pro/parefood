      ...
      >
        <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
          <View style={styles.hero}>
            ...
            <Text style={styles.brand}>PareFood Driver</Text>
            <Text style={styles.tagline}>Terima pesanan dan antar dengan mudah</Text>
          </View>
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>Belum punya akun driver? </Text>
            <Text
