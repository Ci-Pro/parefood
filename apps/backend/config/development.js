// ==========================================
// PareFood Backend — Development Configuration
// ==========================================
...
CONF.database = process.env.SUPABASE_DATABASE_URL || 'postgresql://postgres:postgres@localhost:5432/parefood';

// JWT Authentication
CONF.jwt_secret = process.env.JWT_SECRET || 'parefood-dev-secret-change-in-production';
