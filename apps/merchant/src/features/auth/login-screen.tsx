      ...
      >
        <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
          <View style={styles.hero}>
            ...
            <Text style={styles.brand}>PareFood Merchant</Text>
            <Text style={styles.tagline}>Kelola toko dan pesanan Anda</Text>
          </View>

          <View style={styles.form}>
            <Text style={styles.title}>Masuk Merchant</Text>
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>Belum punya akun merchant? </Text>
            <Text
